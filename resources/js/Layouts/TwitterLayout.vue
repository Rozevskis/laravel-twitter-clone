...
let showUpload = ref('')
let uploadType = ref('')
let randImg1 = ref(`https://picsum.photos/id/${Math.floor(Math.random() * 200)}/100`)
let randImg2 = ref(`https://picsum.photos/id/${Math.floor(Math.random() * 200)}/100`)
        ...
        <div class="max-w-[1400px] flex mx-auto">
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="h-[80px] hover:bg-gray-500 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                <div class="text[14px] text-gray-400">Tennis Tournament LIVE</div>
                                <div class="text[14px] text-white font-extrabold mb-6 text-[17px]">Australian Open 2023</div>
                               
                            </div> 
                            <img :src="randImg2" alt="" class="rounded-xl">
                        </div>
                    </div>
                    <div class=" hover:bg-gray-500 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text[14px] text-gray-400">Trending in United Kingdom</div>
                                <div class="text[14px] text-white font-extrabold mb-6 text-[17px]">Doomsday Clock</div>
                    ...
                    <div class=" hover:bg-gray-500 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text[14px] text-gray-400">Trending in Singapore</div>
                                <div class="text[14px] text-white font-extrabold mb-6 text-[17px]">Singapore Grand Prix</div>
                                <div class="text[14px] text-gray-400">8,245 Tweets</div>
                            </div> 
                            <DotsHorizontal fillColor="#5e5c5c" />
                        </div>
                    </div>
                    <div class=" hover:bg-gray-500 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text[14px] text-gray-400">Trending in Germany</div>
                                <div class="text[14px] text-white font-extrabold mb-6 text-[17px]">Bundesliga</div>
                                <div class="text[14px] text-gray-400">9,123 Tweets</div>
                            </div> 
                            <DotsHorizontal fillColor="#5e5c5c" />
                        </div>
                    </div>
                    <div class=" hover:bg-gray-500 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text[14px] text-white font-extrabold mb-6 text-[17px]">Tour de France</div>
                                <div class="text[14px] text-gray-400">6,789 Tweets</div>
                            </div> 
                            <DotsHorizontal fillColor="#5e5c5c"/>
                        </div>
                    </div>
            ...
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    <div class="inline-block ">
                        <div class="flex items-center border border-grey-700 rounded-full">
